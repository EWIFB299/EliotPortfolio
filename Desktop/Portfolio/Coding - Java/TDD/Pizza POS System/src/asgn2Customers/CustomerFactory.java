...
public class CustomerFactory {
	...
	private static String PickUpCustomerCode = "PUC";
	private static String DroneDeliveryCustomerCode = "DNC";
	private static String DriverDeliveryCustomerCode = "DVC";
	...
	public static Customer getCustomer(String customerCode, String name, String mobileNumber, int locationX,  int locationY) throws CustomerException{
		if (customerCode.equals(PickUpCustomerCode)) {
			return new PickUpCustomer(name, mobileNumber, locationX, locationY);
		} else if (customerCode.equals(DriverDeliveryCustomerCode)) {
			return new DriverDeliveryCustomer(name, mobileNumber, locationX, locationY);
		} else if (customerCode.equals(DroneDeliveryCustomerCode)) {
